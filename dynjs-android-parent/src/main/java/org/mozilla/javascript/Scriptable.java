...
public interface Scriptable {
     ...
     * @param start the object in which the lookup began
     * @return the value of the property (may be null), or NOT_FOUND
     * @see Scriptable#get(String, org.mozilla.javascript.Scriptable)
     */
     ...
     * @see Scriptable#get(String, org.mozilla.javascript.Scriptable)
     * @see org.mozilla.javascript.ScriptableObject#getProperty(org.mozilla.javascript.Scriptable, String)
     */
     ...
     * @see Scriptable#get(int, org.mozilla.javascript.Scriptable)
     * @see org.mozilla.javascript.ScriptableObject#getProperty(org.mozilla.javascript.Scriptable, int)
     */
     ...
     * @see Scriptable#has(String, org.mozilla.javascript.Scriptable)
     * @see Scriptable#get(String, org.mozilla.javascript.Scriptable)
     * @see org.mozilla.javascript.ScriptableObject#putProperty(org.mozilla.javascript.Scriptable, String, Object)
     * @see Context#toObject(Object, org.mozilla.javascript.Scriptable)
     */
     ...
     * @param start the object whose property is being set
     * @param value value to set the property to
     * @see Scriptable#has(int, org.mozilla.javascript.Scriptable)
     * @see Scriptable#get(int, org.mozilla.javascript.Scriptable)
     * @see org.mozilla.javascript.ScriptableObject#putProperty(org.mozilla.javascript.Scriptable, int, Object)
     * @see Context#toObject(Object, org.mozilla.javascript.Scriptable)
     */
     ...
     * @see Scriptable#get(String, org.mozilla.javascript.Scriptable)
     * @see org.mozilla.javascript.ScriptableObject#deleteProperty(org.mozilla.javascript.Scriptable, String)
     */
     ...
     * @param index the numeric index for the property
     * @see Scriptable#get(int, org.mozilla.javascript.Scriptable)
     * @see org.mozilla.javascript.ScriptableObject#deleteProperty(org.mozilla.javascript.Scriptable, int)
     */
