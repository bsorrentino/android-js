                                                  ...
                                                  ConstProperties
{
     ...
     * @see org.mozilla.javascript.ScriptableObject#has(String, org.mozilla.javascript.Scriptable)
     ...
     * for constructors documented in {@link org.mozilla.javascript.FunctionObject#FunctionObject(String, java.lang.reflect.Member, org.mozilla.javascript.Scriptable)}
     *
     ...
     *            the named class
     * @exception java.lang.reflect.InvocationTargetException if an exception is thrown
     ...
     * @see Scriptable#put(String, org.mozilla.javascript.Scriptable, Object)
     */
     ...
     * to {@link org.mozilla.javascript.Scriptable#put(String, org.mozilla.javascript.Scriptable, Object)} on the
     ...
     * the value of the property in <code>obj</code> is changed through a call
     * to {@link org.mozilla.javascript.Scriptable#put(int, org.mozilla.javascript.Scriptable, Object)} on the prototype
     ...
     * of the given scope.
     * The method first calls {@link #getTopLevelScope(org.mozilla.javascript.Scriptable scope)}
