...
/**
 * A builder for {@link org.mozilla.javascript.commonjs.module.Require} instances. Useful when you're creating many
 * instances of {@link org.mozilla.javascript.commonjs.module.Require} that are identical except for their top-level
...
public class RequireBuilder implements Serializable
{
    ...
    /**
     * Sets the {@link ModuleScriptProvider} for the {@link org.mozilla.javascript.commonjs.module.Require} instances
     * that this builder builds.
     * @param moduleScriptProvider the module script provider for the
     * {@link org.mozilla.javascript.commonjs.module.Require} instances that this builder builds.
     ...
     * See {@link org.mozilla.javascript.commonjs.module.Require#Require(Context, Scriptable, ModuleScriptProvider,
     ...
     * either {@link org.mozilla.javascript.commonjs.module.Require#install(Scriptable)} or
     * {@link org.mozilla.javascript.commonjs.module.Require#requireMain(Context, String)} to effectively make it
