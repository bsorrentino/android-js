...
public interface NodeVisitor {
    ...
    /**
     * Visits an AST node.
     * @param node the AST node.  Will never visit an {@link org.mozilla.javascript.ast.AstRoot} node,
     ...
     * the individual {@link org.mozilla.javascript.ast.AstNode} classes should skip any children
