...
public class Context
{
     ...
     * @return a Context associated with the current thread
     * @deprecated use {@link ContextFactory#enterContext(org.mozilla.javascript.Context)} instead as
     * this method relies on usage of a static singleton "global" ContextFactory.
     * @see ContextFactory#enterContext(org.mozilla.javascript.Context)
     * @see ContextFactory#call(ContextAction)
     */
    ...
    /**
     * Call {@link ContextAction#run(org.mozilla.javascript.Context cx)}
     ...
     * {@link ContextAction#run(org.mozilla.javascript.Context)}.
     * @deprecated use {@link ContextFactory#call(ContextAction)} instead as
     * this method relies on usage of a static singleton "global"
     * ContextFactory.
     * @return The result of {@link ContextAction#run(org.mozilla.javascript.Context)}.
     */
    ...
    /**
     * Call {@link
     * Callable#call(org.mozilla.javascript.Context cx, Scriptable scope, Scriptable thisObj,
     *               Object[] args)}
     * using the Context instance associated with the current thread.
     * If no Context is associated with the thread, then
     * {@link ContextFactory#makeContext()} will be called to construct
     * new Context instance. The instance will be temporary associated
     * with the thread during call to {@link ContextAction#run(org.mozilla.javascript.Context)}.
     * <p>
     ...
     *
     * @exception java.io.IOException if an IOException was generated by the Reader
     */
     ...
     * {@link #executeScriptWithContinuations(org.mozilla.javascript.Script, Scriptable)} or
    ...
    /**
     * @deprecated
     * @see #compileReader(java.io.Reader in, String sourceName, int lineno,
     *                     Object securityDomain)
     */
     ...
     * by calling {@link WrapFactory#wrap(org.mozilla.javascript.Context cx, Scriptable scope,
     ...
     * {@link ContextFactory#hasFeature(org.mozilla.javascript.Context cx, int featureIndex)}
     ...
     * <p>
     * The default implementation calls
     * {@link ContextFactory#observeInstructionCount(org.mozilla.javascript.Context cx,
